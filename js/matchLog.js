    ...
    if (!matchData || Object.keys(matchData.playerStats || {}).length === 0) {
        ...
        if (spMatch) {
            ...
            matchData = {
                ...
                our_pts_from_to: spMatch.our_pts_from_to || (this.liveTracker ? this.liveTracker.our_pts_from_to : 0) || 0,
                opp_pts_from_to: spMatch.opp_pts_from_to || (this.liveTracker ? this.liveTracker.opp_pts_from_to : 0) || 0,
